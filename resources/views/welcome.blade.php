            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input id="donor_name" name="donor_name" type="text" placeholder="Enter your name.."
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input id="donor_email" name="donor_email" type="text" placeholder="Enter your email.."
                                class="form-control input-md" required="">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input id="amount" name="amount" class="form-control" placeholder="" type="number" min="10000"
